...
-- Migration 0015: Update create_conversion function validation

BEGIN;

-- Drop and recreate the function with updated validation logic
DROP FUNCTION IF EXISTS create_conversion(UUID, UUID, UUID, UUID, TEXT, TEXT) CASCADE;
