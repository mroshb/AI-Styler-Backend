-- Script to check image status and fix create_conversion function

-- 1. First, check the status of the cloth image
SELECT 
    id,
    user_id,
    vendor_id,
...
-- 2. Check the status of the user image
SELECT 
    id,
    user_id,
    vendor_id,
...
-- 3. Update create_conversion function to allow user's own images
